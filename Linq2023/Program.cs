...
namespace Linq2023
{
    public class Program
    {
        ...
        {
            var queryLondonCustomers3 = from cust in context.clientes where cust.Ciudad == "Londo" orderby cust.NombreCompañia ascending select cust;
        ...
        {
            var queryLondonCustomers3 = context.clientes.Where(cust => cust.Ciudad == "Londo").OrderBy(cust => cust.NombreCompañia);
            foreach (var item in queryLondonCustomers3)
            {
                Console.WriteLine(item.NombreCompañia);
            }
        ...
        {
            var queryCustomersByCity = from cust in context.clientes group cust by cust.Ciudad;
            foreach (var customerGroup in queryCustomersByCity)
            {
                Console.WriteLine(customerGroup.Key);
                foreach(clientes customers in customerGroup)
                {
        ...
        {
            var custQuery = from cust in context.clientes group  cust by cust.Ciudad into custGroup
